"""
Django settings for prd_tests_dev_104634 project.
...
ROOT_URLCONF = 'prd_tests_dev_104634.urls'
...
WSGI_APPLICATION = 'prd_tests_dev_104634.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_tests_dev_104634 API",
    "DESCRIPTION": "API documentation for prd_tests_dev_104634 App",
    "VERSION": "v1",
}
